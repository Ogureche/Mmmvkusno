...
void type1::MeasureTime() {
    ...
    cout << "Время выполнения функции Get_answer(): " << duration.count() << " микросекунд" << endl;
}
...
string inter::Level1() {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            std::cout << "                                                               " << std::endl;
            std::cout << "                                                               " << std::endl;
            std::cout << "                                           Калькулятор завершил работу:)" << std::endl;
            ...
            string s1 = "Ошибка ввода,меню перезагруженно";
            centerTextWithFrame(s1);
...
string inter::Level2() {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            system("cls");
            cout << "Введите коэффеценты A и C: " << endl;
            cin >> A;
            cin >> C;
            type4 eq4(A, C);
            eq4.show();
            ...
            system("cls");
            cout << "Введите коэффеценты A,B и C через пробел: " << endl;
            cin >> A;
            cin >> B;
            cin >> C;
            type6 eq6(A, B, C);
            ...
            system("cls");
            cout << "Введите коэффеценты A и B: " << endl;
            cin >> A;
            cin >> B;
            type8 eq8(A, B);
            eq8.show();
            ...
            string s8 = "Ошибка ввода,меню перезагруженно";
            centerTextWithFrame(s8);
